...
import { LayoutDashboard, ClipboardCheck, PlusCircle, ShoppingBag, LogOut, Menu, X, User } from 'lucide-react';

const navItems = [
  { href: '/salesman', label: 'Dashboard', icon: LayoutDashboard },
  { href: '/salesman/attendance', label: 'Attendance', icon: ClipboardCheck },
  { href: '/salesman/create-order', label: 'Create Order', icon: PlusCircle },
  { href: '/salesman/orders', label: 'Orders', icon: ShoppingBag },
];
